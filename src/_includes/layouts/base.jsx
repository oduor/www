    ...
    <div class='Wrapper'>
      ...
      {templateClass === 'home' && (
        <section class='CompanyIntro'>
          ...
          <p class='SubIntro_text'>Batian Peak is the pioneer in data, analytics and insights for the real economy to truly benefit from intelligence technologies. In noise, the signal of possibilities requires intelligence on intelligence.
          </p>
